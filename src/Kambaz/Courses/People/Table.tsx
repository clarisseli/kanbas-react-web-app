...
export default function PeopleTable() {
    return (
        <div className="container-fluid overflow-auto px-3" id="wd-people-table">
                ...
                <Table striped>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td className="wd-total-activity">12:45:05</td>
                        </tr>
                        <tr>
                            <td className="wd-full-name text-nowrap">
                                <FaUserCircle className="me-2 fs-1 text-secondary" />
                            ...
                            <td className="wd-total-activity">15:00:00</td>
                        </tr>
                    </tbody>
                </Table>
            </div>
