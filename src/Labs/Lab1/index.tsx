        ...
        <div id="wd-lab1">
            ...
            <div id="wd-p-tag">
                ...
                <p id="wd-p-1">
                    ...
                    and render all the text as one single set of sentences. To force the browser to
                    add vertical spacing, wrap the paragraphs you want to separate with the paragraph
                    tag.
                </p>
                <p id="wd-p-2">
